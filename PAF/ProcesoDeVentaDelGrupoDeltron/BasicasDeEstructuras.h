...
void registrarPersonalDeVentas(empleadoDeVentas* empleadosDeVentas, int& empleadosDeVentasCantidad) {
    // Debe de validar si el dni del nuevo empleadoDeVentas ya estï¿½ en uso por otro empleadoDeVentas ya registrado
}

void registrarCliente(cliente* clientes, int& clientesCantidad) {
    // Debe de validar si el ruc del nuevo cliente ya estï¿½ en uso por otro cliente ya registrado
}
